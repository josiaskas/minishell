...
/*   Updated: 2022/03/18 18:29:32 by jkasongo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print_token(t_token *token)
{
	...
	else if ((token->type == e_token_left_paren) || (token->type == e_token_right_paren) || (token->type == e_token_wildcard) || (token->type == e_token_tilde))
	{
		ft_printf("\033[0;31m%s\033[0;39m", token->value);
	}
	else if (token->type == e_token_space)
		ft_printf("\033[0;32m_SPACE_\033[0;39m");
